...
Navigation:
  AppController.show_cluster_pilot() → this screen
  "Zurueck" → AppController.show_screen_3() (ScreenComposer)
...
class ScreenClusterPilot:
    ...
    def _build_header(self) -> ft.Control:
        back_btn = ft.TextButton(
            "← Zurueck",
            on_click=lambda _: self._ctrl.show_screen_3(self._ctrl.state.summary),
        )
        title = ft.Text(
